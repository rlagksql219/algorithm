...
> ⚠️
> 1. 문자 비교할 때 "a" 이렇게 써서 오류남 -> <span style='background-color: #fff5b1'>문자는 'a' 이렇게 표기하는 것 잊지 말기</span>
> 2. 이 문제는 미로 탐색할 때 경로 여러 번 지나갈 수 있다 그래서 visited 배열을 사용하지 않았는데 시간초과 났다. -> 어쨌든 최단 경로를 찾으려면 중복하지 않고 경로를 탐색해야 함
